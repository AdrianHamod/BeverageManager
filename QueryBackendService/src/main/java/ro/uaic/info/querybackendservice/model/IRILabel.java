...
public class IRILabel {

    public final static String NS = "http://www.bem.ro/bem-schema#";
    public final static String NA_BEVERAGE = "http://www.bem.ro/bem-schema#Beverage";
    public final static String BEVERAGE_CTX = "http://www.bem.ro/bem-schema#BeverageContext";
    public final static String CTX_LOCATION = "http://www.bem.ro/bem-schema#BeverageContextLocation";
    public final static String CTX_SEASON = "http://www.bem.ro/bem-schema#BeverageContextSeason";
